...
const Hero = ({ darkMode, toggleDarkMode }) => {
  return (
    <>
      <header className="flex w-full items-center justify-between gap-1 p-4">
        <div className="flex items-center gap-1">
          <img className="w-16 h-16" src={logo} alt="StoryDigest logo" width="64" height="64" loading="eager" />
          <div className="text-3xl font-extrabold dark:text-white">StoryDigest</div>
        </div>
        <button
          onClick={toggleDarkMode}
          className="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 px-4 py-2 rounded-md transition duration-300 ease-in-out"
